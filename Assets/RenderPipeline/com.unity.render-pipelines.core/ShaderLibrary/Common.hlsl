...
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/XBoxOne.hlsl"
#elif defined(SHADER_API_PSSL)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/PSSL.hlsl"
#elif defined(SHADER_API_D3D11)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/D3D11.hlsl"
#elif defined(SHADER_API_METAL)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/Metal.hlsl"
#elif defined(SHADER_API_VULKAN)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/Vulkan.hlsl"
#elif defined(SHADER_API_SWITCH)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/Switch.hlsl"
#elif defined(SHADER_API_GLCORE)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/GLCore.hlsl"
#elif defined(SHADER_API_GLES3)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/GLES3.hlsl"
#elif defined(SHADER_API_GLES)
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/GLES2.hlsl"
#else
#error unsupported shader api
#endif
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/API/Validate.hlsl"

#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/Macros.hlsl"
#include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/Random.hlsl"

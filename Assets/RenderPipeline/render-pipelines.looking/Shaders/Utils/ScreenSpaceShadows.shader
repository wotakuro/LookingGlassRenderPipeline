Shader "Hidden/Lightweight Render Pipeline/ScreenSpaceShadows"
{
    SubShader
    {
        ...
        #include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/Common.hlsl"
        #include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/EntityLighting.hlsl"
        #include "Assets/RenderPipeline/com.unity.render-pipelines.core/ShaderLibrary/ImageBasedLighting.hlsl"
        #include "Assets/RenderPipeline/render-pipelines.looking/ShaderLibrary/Core.hlsl"
        #include "Assets/RenderPipeline/render-pipelines.looking/ShaderLibrary/Shadows.hlsl"

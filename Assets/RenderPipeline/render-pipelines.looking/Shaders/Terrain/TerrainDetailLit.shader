Shader "Hidden/TerrainEngine/Details/Vertexlit" 
{
    ...
    SubShader 
    {
        ...
        Pass
        {
            ...
            #include "Assets/RenderPipeline/render-pipelines.looking/Shaders/UnlitInput.hlsl"
            #include "Assets/RenderPipeline/render-pipelines.looking/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/RenderPipeline/render-pipelines.looking/Shaders/SimpleLitInput.hlsl"
            #include "Assets/RenderPipeline/render-pipelines.looking/Shaders/SimpleLitMetaPass.hlsl"

...
namespace UnityEditor.Experimental.Rendering.LightweightPipeline
{
    ...
    public class LightWeightPBRSubShader : IPBRSubShader
    {
        ...
        {
            return renderPipelineAsset is LookingGlassRenderPipelineAsset;
        }

        static string GetTemplatePath(string templateName)
        {
            var basePath = Path.GetFullPath("Assets/RenderPipeline/render-pipelines.looking/Editor/ShaderGraph");

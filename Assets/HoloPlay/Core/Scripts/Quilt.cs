        ...
        void OnRenderImage(RenderTexture src, RenderTexture dest)
        {
            ...
            for (int i = 0; i < tiling.numViews; i++)
            {
                ...
                foreach (var capture in captures)
                {
                    ...
                    UnityEngine.Profiling.Profiler.BeginSample("RenderToTarget");
                    capture.RenderView(i, tiling.numViews, config.viewCone, config.verticalAngle);
                    UnityEngine.Profiling.Profiler.EndSample();


                    UnityEngine.Profiling.Profiler.BeginSample("CopyToRender");
            ...
            UnityEngine.Profiling.Profiler.BeginSample("FinalBlit");
